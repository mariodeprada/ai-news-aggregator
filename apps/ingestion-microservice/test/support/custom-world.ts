...
import { ArticleNotificationData } from '../../src/core/domain/ports/notification.port';
...
import { InMemoryNotificationRepository } from '../../src/core/domain/test/mocks/in-memory-notification.repository';

export class CustomWorld extends World {
  public articleRepository: InMemoryNewsArticleRepository;
  public notification: InMemoryNotificationRepository;
  ...
  constructor(options: IWorldOptions) {
    ...
    this.notification = new InMemoryNotificationRepository();
